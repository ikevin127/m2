...
void Globals::ReAddressingLocas()
{
	...
	case ServerName::METINPL:
	{
		...
		Globals::pCPythonBackgroundGlobalPositionToMapInfo = Globals::hEntryBaseAddress + 0x76ed0; // [100 ] [1 / 1]
		...
		Globals::pCPythonNetworkStreamSendFishingPacket = Globals::hEntryBaseAddress + 0; // null [100 ] [1 / 1]
		Globals::pCPythonNetworkStreamSendFishingQuitPacket = Globals::hEntryBaseAddress + 0; // null [100 %] [1 / 1]
		...
		Globals::pCPythonNetworkStreamSendShopSellPacketNew = Globals::hEntryBaseAddress + 0x222a40; // [100 ] [1 / 1]
		Globals::pCPythonNetworkStreamSendSpecial = Globals::hEntryBaseAddress + 0x202510; // [100 ] [1 / 1]
		Globals::pCPythonNetworkStreamSendUseSkillPacket = Globals::hEntryBaseAddress + 0x1fc4c0; // [100 ] [1 / 1]
		Globals::pCPythonNetworkStreamSendWhisperPacket = Globals::hEntryBaseAddress + 0; // null [100 ] [1 / 1]
		Globals::pCPythonNetworkStreamServerCommand = Globals::hEntryBaseAddress + 0x1edff0; // [100 ] [1 / 1]
		Globals::pCPythonNonPlayerGetTable = Globals::hEntryBaseAddress + 0xe7150; // [100 ] [1 / 1]
		Globals::pCPythonPlayerClickSkillSlot = Globals::hEntryBaseAddress + 0x120250; // [100 ] [1 / 1]
		Globals::pCPythonPlayerGetItemIndex = Globals::hEntryBaseAddress + 0xf0b10; // [100 ] [1 / 1]
		Globals::pCPythonPlayerGetItemMetinSocket = Globals::hEntryBaseAddress + 0xf1050; // [100 ] [1 / 1]
		Globals::pCPythonPlayerGetMainCharacterIndex = Globals::hEntryBaseAddress + 0xefe10; // [100 ] [1 / 1]
		Globals::pCPythonPlayerGetName = Globals::hEntryBaseAddress + 0xf0670; // [100 ] [1 / 1]
		Globals::pCPythonPlayerGetRace = Globals::hEntryBaseAddress + 0xeff80; // [100 ] [1 / 1]
		Globals::pCPythonPlayerGetStatus = Globals::hEntryBaseAddress + 0xf0630; // [100 ] [1 / 1]
		Globals::pCPythonPlayerGetTargetVID = Globals::hEntryBaseAddress + 0x107610; // [100 ] [1 / 1]
		Globals::pCPythonPlayerIsSkillActive = Globals::hEntryBaseAddress + 0xf29b0; // [100 ] [1 / 1]
		Globals::pCPythonPlayerIsSkillCoolTime = Globals::hEntryBaseAddress + 0xf2980; // [100 ] [1 / 1]
		Globals::pCPythonPlayerNEW_Fishing = Globals::hEntryBaseAddress + 0x108350; // [100 ] [1 / 1]
		Globals::pCPythonPlayerNEW_GetMainActorPtr = Globals::hEntryBaseAddress + 0xef8c0; // [100 ] [1 / 1]
		Globals::pCPythonPlayerSetAttackKeyState = Globals::hEntryBaseAddress + 0x1092c0; // [100 ] [1 / 1]
		Globals::pCPythonPlayerSetTarget = Globals::hEntryBaseAddress + 0x107670; // [100 ] [1 / 1]
		Globals::pCPythonPlayer__OnClickActor = Globals::hEntryBaseAddress + 0x107ba0; // [100 ] [1 / 1]
		Globals::pCPythonPlayer__OnPressActor = Globals::hEntryBaseAddress + 0x107d00; // [100 ] [1 / 1]
		Globals::pCGraphicTextureGetD3DTexture = Globals::hEntryBaseAddress + 0x4365c0; // [100 ] [1 / 1]
		Globals::pCResourceManagerGetResourcePointer = Globals::hEntryBaseAddress + 0x41eaa0; // [100 ] [1 / 1]
		Globals::pCGraphicImageGetTexturePointer = Globals::hEntryBaseAddress + 0x4494b0; // [100 ] [1 / 1]
		Globals::pPyCallClassMemberFunc = Globals::hEntryBaseAddress + 0x46cb10; // [100 ] [1 / 1]
		Globals::pCInputKeyboardUpdateKeyboard = Globals::hEntryBaseAddress + 0x434150; // [100 ] [1 / 1]
		Globals::pCInstanceBaseIsWaiting = Globals::hEntryBaseAddress + 0x72df0; // [100 ] [1 / 1]
		Globals::pCInstanceBaseSetRotation = Globals::hEntryBaseAddress + 0x73410; // [100 ] [1 / 1]
		Globals::pCInstanceBase__GetBackgroundHeight = Globals::hEntryBaseAddress + 0x550a0; // [100 ] [1 / 1]
		Globals::pCResourceReload = Globals::hEntryBaseAddress + 0x436b60; // [100 ] [1 / 1]
		Globals::pCPythonPlayerGetItemCount = Globals::hEntryBaseAddress + 0xf0d80; // [100 ] [1 / 1]
		Globals::pCPythonPlayerGetItemAttribute = Globals::hEntryBaseAddress + 0x1fdd00; // [100 ] [1 / 1]
		Globals::pCPythonNetworkStreamSendItemUseToItemPacket = Globals::hEntryBaseAddress + 0x222d10; // [50 ] [1 / 2]
		break;
	}
